 ...
 *  判断是不是在中国
 */
- (BOOL)isLocationOutOfChina
{
    if (self.coordinate.longitude < 72.004 || self.coordinate.longitude > 137.8347 || self.coordinate.latitude < 0.8293 || self.coordinate.latitude > 55.8271)
        return YES;
    return NO;
}
